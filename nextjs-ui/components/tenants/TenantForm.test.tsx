 ...
 * Story 32: Complete Field Coverage - BYOK, Budget, Tools, Webhook, Enhancement Prefs, Accordion
 *
...
describe('TenantForm', () => {
  ...
  describe('Story 32: BYOK Section (AC-1)', () => {
    it('should not show API key fields when BYOK is disabled by default', () => {
      ...
      const byokToggle = screen.getByRole('switch', { name: /byok enabled/i })
  ...
  describe('Story 32: Budget Section (AC-2)', () => {
    ...
    it('should format budget as currency in display', () => {
      render(
        <TenantForm
          onSubmit={mockOnSubmit}
          defaultValues={{
      ...
      // Check if currency formatting is present
  ...
  describe('Story 32: Webhook Secret Generator (AC-4)', () => {
    it('should generate webhook secret when button clicked', async () => {
      ...
      const generateButton = screen.getByRole('button', { name: /generate secret/i })
  ...
  describe('Story 32: Enhancement Preferences Dual-Mode (AC-5)', () => {
    it('should start in simple form mode by default', () => {
      ...
      expect(screen.getByLabelText(/kb timeout/i)).toBeInTheDocument()
  ...
  describe('Story 32: Is Active Toggle (AC-6)', () => {
    it('should show warning when is_active is toggled to false', async () => {
      ...
      const isActiveToggle = screen.getByRole('switch', { name: /is active/i })
  ...
  describe('Story 32: Accessibility (AC-10)', () => {
    it('should have proper ARIA labels for all switches', () => {
      ...
      expect(screen.getByRole('switch', { name: /byok enabled/i })).toBeInTheDocument()
      expect(screen.getByRole('switch', { name: /is active/i })).toBeInTheDocument()
      expect(screen.getByRole('switch', { name: /include monitoring/i })).toBeInTheDocument()
    })
