...
export default function Loading() {
  return (
    <div className="container mx-auto p-6">
      <div className="h-10 w-96 bg-white/50 dark:bg-white/10 animate-pulse rounded mb-6" />
      <div className="h-6 w-64 bg-white/50 dark:bg-white/10 animate-pulse rounded mb-8" />
